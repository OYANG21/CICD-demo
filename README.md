...
```bash
sam-api$ sam logs -n HelloEfsFunction --stack-name sam-api --tail
```
...
sam-api$ AWS_SAM_STACK_NAME=<stack-name> python -m pytest tests/integration -v
```
...
```bash
aws cloudformation delete-stack --stack-name sam-api
```
